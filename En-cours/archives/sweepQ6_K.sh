...
MODEL="/Volumes/NM790-II/Qwen3-4B-Q6_K.gguf"
...
#     export GGML_METAL_PP_Q6K_NR0=$pp_nr0
#     export GGML_METAL_PP_Q6K_NSG=$pp_nsg
#     echo "===== Q6_K_M PP NR0=$pp_nr0 NSG=$pp_nsg ====="
#     ./build/bin/llama-bench -ngl 99 -fa 1 -ub 32 -b 512 -p 4096 -n 0 --mmap 0 -m "$MODEL"
#     #./build/bin/llama-cli -st -p 'expliques-moi Tensorflow' -ngl 99 --no-mmap --jinja --ctx-size 80144 -fa 1 -ub 32 -b 512 -n 512 -m "$MODEL"
#   done
# done
#
# for dec_nr0 in 2 4 8; do
#   for dec_nsg in 1 2 4; do
#     export GGML_METAL_DECODE_Q6K_NR0=$dec_nr0
#     export GGML_METAL_DECODE_Q6K_NSG=$dec_nsg
#     export GGML_METAL_DECODE_Q6K_SHAPE_THRESHOLD=2048
#     echo "===== Q6_K_M TG NR0=$dec_nr0 NSG=$dec_nsg ====="
...
for dec_nr0 in 2 4 8; do
  for dec_nsg in 1 2 4; do
    export GGML_METAL_DECODE_Q6K_ID_NR0=$dec_nr0
    export GGML_METAL_DECODE_Q6K_ID_NSG=$dec_nsg
    echo "===== Q6_K_M TG DECODE_Q6K_ID_NR0=$dec_nr0 DECODE_Q6K_ID_NSG=$dec_nsg ====="
